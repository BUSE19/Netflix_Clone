...
class MovieDetailledModel {
  ...
  factory MovieDetailledModel.fromRawJson(String str) =>
      MovieDetailledModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MovieDetailledModel.fromJson(Map<String, dynamic> json) =>
      MovieDetailledModel(
        adult: json["adult"],
